...
if __name__ == "__main__":
    ...
    model_path      = r'E:\Mycodes\segformer-pytorch-master\logs\Test\ep200-loss0.877-val_loss0.978.pth'
    ...
    #------------------------------------------------------------------#
    save_dir            = r'E:\Mycodes\segformer-pytorch-master\logs\Test5'
    eval_flag           = True
    eval_period         = 10
    #------------------------------------------------------------------#
    #   VOCdevkit_path  数据集路径
    #------------------------------------------------------------------#
    VOCdevkit_path  = r'E:\Mycodes\Data'
    #------------------------------------------------------------------#
    #   建议选项：
    #   种类少（几类）时，设置为True
    ...
    #   读取数据集对应的txt
    #---------------------------#
    with open(os.path.join(VOCdevkit_path, "VOCdevkit/VOC2007/ImageSets/Segmentation/train.txt"),"r") as f:
        train_lines = f.readlines()
    with open(os.path.join(VOCdevkit_path, "VOCdevkit/VOC2007/ImageSets/Segmentation/val.txt"),"r") as f:
        val_lines = f.readlines()
    #
    # with open(os.path.join(VOCdevkit_path, "Trans10K-cls12/ImageSets/Segmentation/train.txt"),"r") as f:
    #     train_lines = f.readlines()
    # with open(os.path.join(VOCdevkit_path, "Trans10K-cls12/ImageSets/Segmentation/val.txt"),"r") as f:
    #     val_lines = f.readlines()
